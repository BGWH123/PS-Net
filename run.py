...
#Our
parser.add_argument("--drop_cols",type=str,    default="U,WS,lon,lat,lev_x,lev_y,PHIS,lev,source_file",help="to delete")
parser.add_argument("--result_name",type=str,    default="result.csv",help="result file name")
parser.add_argument("--test_finalize", action='store_true', default=False, help='test_finalize')
parser.add_argument("--recorder_name",type=str,    default="recode.txt",help="recorder file name")
